...
const WEAPONS = [
  ...
  { id: 'bat',        type: 'melee', dmg: 32,  rate: 520, range: 50, color: '#7a4a20' },
  ...
  { id: 'axe',        type: 'melee', dmg: 60,  rate: 580, range: 50, color: '#9a7a5a' },
  ...
  { id: 'sledge',     type: 'melee', dmg: 100, rate: 780, range: 52, color: '#6a6a6a' },
  ...
  { id: 'lightsaber', type: 'melee', dmg: 150, rate: 350, range: 78, color: '#3aff5a', pierce: true },
  ...
  { id: 'revolver',   type: 'gun',   dmg: 42,  rate: 580, speed: 760, mag: 6,  reload: 1500, spread: 0.02, color: '#ffae3a' },
  { id: 'burstpistol',type: 'gun',   dmg: 16,  rate: 480, speed: 720, mag: 24, reload: 1500, spread: 0.04, color: '#ffae3a', burstCount: 3, burstDelay: 70, ammoCost: 3 },
  ...
  { id: 'crossbow',   type: 'gun',   dmg: 90,  rate: 900, speed: 950, mag: 4,  reload: 1700, spread: 0.0,  color: '#7a5a3a', pierce: true },
  ...
  { id: 'boomerang',  type: 'gun',   dmg: 50,  rate: 800, speed: 600, mag: 2, reload: 1500, spread: 0.0, color: '#9a6a30', pierce: true, returns: true },
  ...
  { id: 'timestop',   type: 'gun',   dmg: 70,  rate: 900, speed: 1100, mag: 3, reload: 2500, spread: 0.0, color: '#9aff5a', timeStopMs: 1000 },
  { id: 'blackhole',  type: 'gun',   dmg: 60,  rate: 1200, speed: 480, mag: 4, reload: 2400, spread: 0.0, color: '#aa3aff', pullRadius: 200 },
