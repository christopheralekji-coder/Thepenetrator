...
const HEIST_ARENA = {
  ...
  // === DECORATIONS (300+ entries — fyller alla rum, v1.632) ===
  decorations: [
    // ===== STORAGE ROOM (x=625-1275, y=725-1075) =====
    { kind: 'cardboard_box', x: 680,  y: 780 },
    { kind: 'cardboard_box', x: 730,  y: 770 },
    { kind: 'cardboard_box', x: 780,  y: 790 },
    { kind: 'cardboard_box', x: 830,  y: 775 },
    { kind: 'cardboard_box', x: 1000, y: 770 },
    { kind: 'cardboard_box', x: 1060, y: 790 },
    { kind: 'cardboard_box', x: 1120, y: 780 },
    { kind: 'cardboard_box', x: 1180, y: 800 },
    { kind: 'cardboard_box', x: 1230, y: 790 },
    { kind: 'pallet',        x: 740,  y: 1020 },
    { kind: 'pallet',        x: 900,  y: 1020 },
    { kind: 'pallet',        x: 1060, y: 1020 },
    { kind: 'pallet',        x: 1220, y: 1020 },
    { kind: 'fire_extinguisher', x: 660, y: 830 },
    { kind: 'fire_extinguisher', x: 1245, y: 830 },
    { kind: 'shopping_cart', x: 980,  y: 870 },
    { kind: 'shopping_cart', x: 1150, y: 870 },
    { kind: 'trash',         x: 660,  y: 950 },
    { kind: 'trash_pile',    x: 1250, y: 950 },
    { kind: 'gold_bar_box',  x: 920,  y: 950 },
    ...
    // ===== LOCKER ROOM (x=2700-3375, y=725-1075) =====
    { kind: 'locker',      x: 2730, y: 760 },
    { kind: 'locker',      x: 2780, y: 760 },
    { kind: 'locker',      x: 2830, y: 760 },
    { kind: 'locker',      x: 2880, y: 760 },
    { kind: 'locker',      x: 2950, y: 760 },
    { kind: 'locker',      x: 3000, y: 760 },
    { kind: 'locker',      x: 3050, y: 760 },
    { kind: 'locker',      x: 3120, y: 760 },
    { kind: 'locker',      x: 3170, y: 760 },
    { kind: 'locker',      x: 3220, y: 760 },
    { kind: 'locker',      x: 3270, y: 760 },
    { kind: 'locker',      x: 3320, y: 760 },
    { kind: 'locker_open', x: 2780, y: 1020 },
    { kind: 'locker_open', x: 2900, y: 1020 },
    { kind: 'locker_open', x: 3050, y: 1020 },
    { kind: 'locker_open', x: 3200, y: 1020 },
    { kind: 'locker_open', x: 3320, y: 1020 },
    { kind: 'bench',       x: 2800, y: 900 },
    { kind: 'bench',       x: 2960, y: 900 },
    { kind: 'bench',       x: 3120, y: 900 },
    { kind: 'bench',       x: 3280, y: 900 },
    { kind: 'mop_bucket',  x: 2730, y: 1020 },
    { kind: 'umbrella_stand', x: 3350, y: 760 },

    // ===== NETWORK CLOSET (x=625-1275, y=1100-1675) =====
    { kind: 'server_rack',   x: 680,  y: 1150 },
    { kind: 'server_rack',   x: 760,  y: 1150 },
    { kind: 'server_rack',   x: 840,  y: 1150 },
    { kind: 'server_rack',   x: 920,  y: 1150 },
    { kind: 'server_rack',   x: 1000, y: 1150 },
    { kind: 'server_rack',   x: 1080, y: 1150 },
    { kind: 'server_rack',   x: 1160, y: 1150 },
    { kind: 'server_rack',   x: 1240, y: 1150 },
    { kind: 'master_switch', x: 750,  y: 1380 },
    { kind: 'master_switch', x: 1100, y: 1380 },
    { kind: 'cable_pile',    x: 880,  y: 1380 },
    { kind: 'cable_pile',    x: 1200, y: 1380 },
    { kind: 'cable_tray',    x: 950,  y: 1450 },
    { kind: 'cable_tray',    x: 700,  y: 1450 },
    { kind: 'cable_tray',    x: 1200, y: 1450 },
    { kind: 'cooling_unit',  x: 700,  y: 1620 },
    { kind: 'cooling_unit',  x: 1200, y: 1620 },
    { kind: 'air_conditioner', x: 950, y: 1620 },
    ...
    // ===== SECURITY ROOM (x=2700-3375, y=1100-1675) =====
    { kind: 'monitor_wall',    x: 2780, y: 1180 },
    { kind: 'monitor_wall',    x: 3100, y: 1180 },
    { kind: 'monitor_wall',    x: 3300, y: 1180 },
    { kind: 'security_desk',   x: 2780, y: 1450 },
    { kind: 'security_desk',   x: 2950, y: 1450 },
    { kind: 'office_chair',    x: 2780, y: 1530 },
    { kind: 'office_chair',    x: 2950, y: 1530 },
    { kind: 'coffee_mug',      x: 2780, y: 1430 },
    { kind: 'coffee_mug',      x: 2950, y: 1430 },
    { kind: 'master_terminal', x: 3250, y: 1550 },
    { kind: 'filing_cabinet',  x: 3050, y: 1180 },
    { kind: 'filing_cabinet',  x: 3050, y: 1450 },
    { kind: 'plant',           x: 2750, y: 1350 },
    { kind: 'plant',           x: 3340, y: 1350 },
    { kind: 'printer',         x: 3200, y: 1450 },
    { kind: 'water_cooler',    x: 2750, y: 1620 },
    { kind: 'coffee_machine',  x: 3340, y: 1620 },

    // ===== SERVER ROOM (x=625-1275, y=1700-1975) =====
    { kind: 'server_rack', x: 680,  y: 1730 },
    { kind: 'server_rack', x: 760,  y: 1730 },
    { kind: 'server_rack', x: 840,  y: 1730 },
    { kind: 'server_rack', x: 920,  y: 1730 },
    { kind: 'server_rack', x: 1000, y: 1730 },
    { kind: 'server_rack', x: 1080, y: 1730 },
    { kind: 'server_rack', x: 1160, y: 1730 },
    { kind: 'server_rack', x: 1240, y: 1730 },
    { kind: 'server_rack', x: 680,  y: 1900 },
    { kind: 'server_rack', x: 760,  y: 1900 },
    { kind: 'server_rack', x: 840,  y: 1900 },
    { kind: 'server_rack', x: 1080, y: 1900 },
    { kind: 'server_rack', x: 1160, y: 1900 },
    { kind: 'server_rack', x: 1240, y: 1900 },
    { kind: 'cooling_unit',x: 970,  y: 1900 },
    { kind: 'cable_tray',  x: 700,  y: 1820 },
    { kind: 'cable_tray',  x: 950,  y: 1820 },
    { kind: 'cable_tray',  x: 1200, y: 1820 },
    { kind: 'cable_pile',  x: 970,  y: 1820 },

    // ===== HALLWAY (x=1300-2675, y=1700-1975) =====
    { kind: 'plant',          x: 1380, y: 1730 },
    { kind: 'plant',          x: 2600, y: 1730 },
    { kind: 'plant',          x: 1380, y: 1930 },
    { kind: 'plant',          x: 2600, y: 1930 },
    { kind: 'framed_picture', x: 1500, y: 1720 },
    { kind: 'framed_picture', x: 1700, y: 1720 },
    { kind: 'framed_picture', x: 2300, y: 1720 },
    { kind: 'framed_picture', x: 2500, y: 1720 },
    { kind: 'bench',          x: 1500, y: 1900 },
    { kind: 'bench',          x: 2500, y: 1900 },
    { kind: 'bench',          x: 1700, y: 1900 },
    { kind: 'bench',          x: 2300, y: 1900 },
    { kind: 'bank_logo_floor',x: 2000, y: 1830 },
    { kind: 'exit_sign',      x: 1320, y: 1730 },
    { kind: 'exit_sign',      x: 2670, y: 1730 },
    { kind: 'wall_mounted_sign', x: 1900, y: 1720 },
    { kind: 'wall_mounted_sign', x: 2100, y: 1720 },

    // ===== MANAGER TOP (reception zone, x=2700-3375, y=1700-2000) =====
    { kind: 'reception_desk', x: 2850, y: 1800 },
    { kind: 'office_chair',   x: 2850, y: 1880 },
    { kind: 'plant',          x: 2750, y: 1730 },
    { kind: 'plant',          x: 3350, y: 1730 },
    { kind: 'plant',          x: 2750, y: 1950 },
    { kind: 'plant',          x: 3350, y: 1950 },
    { kind: 'office_couch',   x: 3100, y: 1850 },
    { kind: 'coffee_table',   x: 3250, y: 1850 },
    { kind: 'magazine_rack',  x: 3300, y: 1750 },
    { kind: 'framed_picture', x: 3000, y: 1720 },

    // ===== MANAGER OFFICE BOT (x=2700-3375, y=2000-2400) =====
    { kind: 'desk',           x: 3150, y: 2100 },
    { kind: 'chair',          x: 3150, y: 2200 },
    { kind: 'safe',           x: 3320, y: 2050 },
    { kind: 'safety_box',     x: 3320, y: 2150 },
    { kind: 'bookshelf',      x: 2780, y: 2050 },
    { kind: 'bookshelf',      x: 2780, y: 2150 },
    { kind: 'bookshelf',      x: 2780, y: 2350 },
    { kind: 'filing_cabinet', x: 2950, y: 2050 },
    { kind: 'filing_cabinet', x: 3050, y: 2050 },
    { kind: 'plant',          x: 2750, y: 2380 },
    { kind: 'plant',          x: 3340, y: 2380 },
    { kind: 'office_couch',   x: 3000, y: 2350 },
    { kind: 'coffee_table',   x: 3200, y: 2350 },
    { kind: 'framed_picture', x: 3150, y: 2030 },
    { kind: 'framed_picture', x: 2900, y: 2030 },
    { kind: 'whiteboard',     x: 3000, y: 2030 },
    { kind: 'laptop',         x: 3150, y: 2100 },
    { kind: 'coffee_mug',     x: 3120, y: 2100 },

    // ===== BREAK ROOM (x=625-1275, y=2000-2400) =====
    { kind: 'fridge',         x: 680,  y: 2080 },
    { kind: 'sink_counter',   x: 740,  y: 2080 },
    { kind: 'coffee_machine', x: 800,  y: 2080 },
    { kind: 'microwave',      x: 870,  y: 2080 },
    { kind: 'vending_machine',x: 950,  y: 2080 },
    { kind: 'tv_wall',        x: 1100, y: 2050 },
    { kind: 'tv_wall',        x: 1200, y: 2050 },
    { kind: 'round_table',    x: 750,  y: 2230 },
    { kind: 'round_table',    x: 950,  y: 2230 },
    { kind: 'office_chair',   x: 700,  y: 2200 },
    { kind: 'office_chair',   x: 800,  y: 2200 },
    { kind: 'office_chair',   x: 700,  y: 2270 },
    { kind: 'office_chair',   x: 800,  y: 2270 },
    { kind: 'office_chair',   x: 900,  y: 2200 },
    { kind: 'office_chair',   x: 1000, y: 2200 },
    { kind: 'office_chair',   x: 900,  y: 2270 },
    { kind: 'office_chair',   x: 1000, y: 2270 },
    { kind: 'office_couch',   x: 1150, y: 2200 },
    { kind: 'office_couch',   x: 1150, y: 2330 },
    { kind: 'tip_jar',        x: 760,  y: 2230 },
    { kind: 'plant',          x: 660,  y: 2380 },
    { kind: 'plant',          x: 1250, y: 2380 },
    { kind: 'magazine_rack',  x: 1230, y: 2120 },
    { kind: 'water_cooler',   x: 1230, y: 2230 },

    // ===== CONFERENCE ROOM (x=1300-1675, y=2000-2400) — RELOCATED för smalare rum =====
    { kind: 'conference_table', x: 1490, y: 2200 },
    { kind: 'office_chair',   x: 1380, y: 2120 },
    { kind: 'office_chair',   x: 1490, y: 2110 },
    { kind: 'office_chair',   x: 1600, y: 2120 },
    { kind: 'office_chair',   x: 1380, y: 2280 },
    { kind: 'office_chair',   x: 1490, y: 2290 },
    { kind: 'office_chair',   x: 1600, y: 2280 },
    { kind: 'projector',      x: 1490, y: 2050 },
    { kind: 'whiteboard',     x: 1490, y: 2030 },
    { kind: 'laptop',         x: 1430, y: 2200 },
    { kind: 'laptop',         x: 1550, y: 2200 },
    { kind: 'water_cooler',   x: 1340, y: 2380 },
    { kind: 'plant',          x: 1640, y: 2380 },
    { kind: 'framed_picture', x: 1330, y: 2020 },
    { kind: 'framed_picture', x: 1640, y: 2020 },

    // ===== CENTRAL CORRIDOR (x=1700-2100, y=2000-2400) — open through-path =====
    { kind: 'bank_logo_floor',x: 1900, y: 2200 },
    { kind: 'floor_mat',      x: 1900, y: 2050 },
    { kind: 'floor_mat',      x: 1900, y: 2380 },
    { kind: 'plant',          x: 1720, y: 2050 },
    { kind: 'plant',          x: 2080, y: 2050 },
    { kind: 'plant',          x: 1720, y: 2380 },
    { kind: 'plant',          x: 2080, y: 2380 },
    { kind: 'rope_barrier',   x: 1730, y: 2200 },
    { kind: 'rope_barrier',   x: 2030, y: 2200 },
    { kind: 'directory_sign', x: 1900, y: 2120 },
    { kind: 'directory_sign', x: 1900, y: 2330 },
    ...
    { kind: 'office_chair', x: 2200, y: 2570 },
    { kind: 'office_chair', x: 2375, y: 2570 },
    { kind: 'office_chair', x: 2575, y: 2570 },
    { kind: 'photocopier',  x: 1340, y: 2620 },
    { kind: 'photocopier',  x: 2620, y: 2620 },
    { kind: 'printer',      x: 1500, y: 2640 },
    { kind: 'printer',      x: 2500, y: 2640 },
    { kind: 'water_cooler', x: 1900, y: 2640 },
    { kind: 'water_cooler', x: 2100, y: 2640 },

    // ===== MAIN LOBBY (x=625-3375, y=2700-3100) =====
    ...
    { kind: 'plant',       x: 850,  y: 3000 },
    { kind: 'plant',       x: 1150, y: 3050 },
    { kind: 'plant',       x: 1350, y: 3000 },
    { kind: 'plant',       x: 2650, y: 3000 },
    { kind: 'plant',       x: 2850, y: 3050 },
    { kind: 'plant',       x: 3150, y: 3000 },
    { kind: 'bench',       x: 1400, y: 2900 },
    { kind: 'bench',       x: 2600, y: 2900 },
    { kind: 'bench',       x: 1500, y: 2950 },
    { kind: 'bench',       x: 2500, y: 2950 },
    { kind: 'bench',       x: 1300, y: 3000 },
    { kind: 'bench',       x: 2700, y: 3000 },
    { kind: 'floor_mat',   x: 2000, y: 2780 },
    { kind: 'floor_mat',   x: 2000, y: 3080 },
    { kind: 'bank_logo_floor', x: 2000, y: 2950 },
    { kind: 'trash',       x: 720,  y: 3070 },
    { kind: 'trash',       x: 3280, y: 3070 },
    { kind: 'trash',       x: 1100, y: 3070 },
    { kind: 'trash',       x: 2900, y: 3070 },
    { kind: 'promo_banner',x: 1450, y: 2780 },
    { kind: 'promo_banner',x: 2550, y: 2780 },
    { kind: 'info_kiosk',  x: 1800, y: 2820 },
    { kind: 'info_kiosk',  x: 2200, y: 2820 },
    { kind: 'directory_sign', x: 1900, y: 2780 },
    { kind: 'directory_sign', x: 2100, y: 2780 },
    { kind: 'umbrella_stand', x: 770,  y: 2750 },
    { kind: 'umbrella_stand', x: 3230, y: 2750 },
    { kind: 'rope_barrier',   x: 1300, y: 2780 },
    { kind: 'rope_barrier',   x: 2600, y: 2780 },

    // ===== RECEPTION FOYER (x=625-3375, y=3100-3300) =====
    { kind: 'reception_desk', x: 2000, y: 3170 },
    { kind: 'office_chair',   x: 1900, y: 3220 },
    { kind: 'office_chair',   x: 2000, y: 3220 },
    { kind: 'office_chair',   x: 2100, y: 3220 },
    { kind: 'plant',          x: 700,  y: 3220 },
    { kind: 'plant',          x: 900,  y: 3220 },
    { kind: 'plant',          x: 3100, y: 3220 },
    { kind: 'plant',          x: 3300, y: 3220 },
    { kind: 'framed_picture', x: 1100, y: 3180 },
    { kind: 'framed_picture', x: 1300, y: 3180 },
    { kind: 'framed_picture', x: 2700, y: 3180 },
    ...
    { kind: 'bench',          x: 1100, y: 3260 },
    { kind: 'bench',          x: 2900, y: 3260 },
    { kind: 'magazine_rack',  x: 1700, y: 3260 },
    { kind: 'magazine_rack',  x: 2300, y: 3260 },
    { kind: 'water_cooler',   x: 900,  y: 3270 },
    { kind: 'water_cooler',   x: 3100, y: 3270 },
