...
const CACHE = 'penetrator-v757-cc0-sfx';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=757',
  ...
  './assets/sfx/shootGun.ogg?v=757',
  './assets/sfx/shootEnergy.ogg?v=757',
  './assets/sfx/shootHeavy.ogg?v=757',
  './assets/sfx/hit.ogg?v=757',
  './assets/sfx/hitCrit.ogg?v=757',
  './assets/sfx/kill.ogg?v=757',
  './assets/sfx/explosion.ogg?v=757',
  './assets/sfx/goldPickup.ogg?v=757',
  './assets/sfx/reloadStart.ogg?v=757',
  './assets/sfx/reloadDone.ogg?v=757',
  './assets/sfx/uiClick.ogg?v=757',
  './assets/sfx/uiHover.ogg?v=757',
  './assets/sfx/bossSpawn.ogg?v=757',
  './assets/sfx/bossDeath.ogg?v=757',
  './shared/ctf-arena.js',
