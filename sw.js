...
const CACHE = 'penetrator-v758-full-sfx';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=758',
  ...
  './assets/sfx/shootGun.ogg?v=758',
  './assets/sfx/shootRapid.ogg?v=758',
  './assets/sfx/shootShotgun.ogg?v=758',
  './assets/sfx/shootBig.ogg?v=758',
  './assets/sfx/shootEnergy.ogg?v=758',
  './assets/sfx/shootHeavy.ogg?v=758',
  './assets/sfx/shootThrow.ogg?v=758',
  './assets/sfx/shootMelee.ogg?v=758',
  './assets/sfx/hit.ogg?v=758',
  './assets/sfx/hitCrit.ogg?v=758',
  './assets/sfx/kill.ogg?v=758',
  './assets/sfx/explosion.ogg?v=758',
  './assets/sfx/dash.ogg?v=758',
  './assets/sfx/shield.ogg?v=758',
  './assets/sfx/grenadeThrow.ogg?v=758',
  './assets/sfx/goldPickup.ogg?v=758',
  './assets/sfx/reloadStart.ogg?v=758',
  './assets/sfx/reloadDone.ogg?v=758',
  './assets/sfx/purchase.ogg?v=758',
  './assets/sfx/uiClick.ogg?v=758',
  './assets/sfx/uiHover.ogg?v=758',
  './assets/sfx/uiBack.ogg?v=758',
  './assets/sfx/uiError.ogg?v=758',
  './assets/sfx/bossSpawn.ogg?v=758',
  './assets/sfx/bossDeath.ogg?v=758',
  './shared/ctf-arena.js',
