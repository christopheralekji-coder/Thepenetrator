...
const WEAPONS = [
  ...
  { id: 'fists',   type: 'melee', dmg: 8,   rate: 380, range: 36, color: '#dab27a', botRange: 50 },

  // ── MELEE (2) — båda ger rörelse; ingen distans = svagheten ───────────────
  { id: 'knife',   type: 'melee', dmg: 26,  rate: 200, range: 40, color: '#bcc8d0', moveSpeedMul: 1.25, botRange: 55 },
  { id: 'katana',  type: 'melee', dmg: 60,  rate: 330, range: 56, color: '#e6e6f0', moveSpeedMul: 1.10, pierce: true, botRange: 70 },

  // ── PISTOLER (2) ───────────────────────────────────────────────────────────
  // pistol: START, rent/pålitligt — noll spridning + snabb omladdning; låg DPS.
  { id: 'pistol',     type: 'gun', dmg: 24, rate: 300, speed: 820, mag: 14, reload: 900,  spread: 0.0,  color: '#ffd14a', botRange: 320 },
  ...
  { id: 'dualpistol', type: 'gun', dmg: 18, rate: 150, speed: 780, mag: 24, reload: 1400, spread: 0.085, color: '#ffae3a', dualWield: true, moveSpeedMul: 1.15, botRange: 280 },

  // ── HAGEL (2) ──────────────────────────────────────────────────────────────
  // shotgun: PUMP — stoppkraft nära; långsam pumpning + kort räckvidd.
  { id: 'shotgun',     type: 'gun', dmg: 16, rate: 760, speed: 760, mag: 6,  reload: 2000, spread: 0.28, pellets: 8, color: '#ff6b3d', botRange: 220 },
  // autoshotgun: full-auto hagel; extrem spridning + äter ammo.
  { id: 'autoshotgun', type: 'gun', dmg: 11, rate: 300, speed: 720, mag: 10, reload: 2200, spread: 0.36, pellets: 6, color: '#ff8a3d', botRange: 200 },

  // ── SMG (2) ────────────────────────────────────────────────────────────────
  // smg: MINI UZI — eldstorm + rörlig; låg skada/kula, kort räckvidd.
  { id: 'smg',     type: 'gun', dmg: 13, rate: 80,  speed: 720, mag: 28, reload: 1300, spread: 0.09, color: '#88ccff', botRange: 260 },
  ...
  { id: 'dualuzi', type: 'gun', dmg: 11, rate: 48,  speed: 700, mag: 40, reload: 2000, spread: 0.17, color: '#aaccff', dualWield: true, botRange: 220 },
  ...
  { id: 'ak',     type: 'gun', dmg: 26, rate: 135, speed: 850, mag: 30, reload: 1900, spread: 0.045, color: '#caa46a', recoilRamp: 0.22, botRange: 420 },
  // rifle: AUTOMATKARBIN — kontroll (tight 3-burst, hög precision); lägre topp-DPS.
  { id: 'rifle',  type: 'gun', dmg: 22, rate: 110, speed: 900, mag: 24, reload: 1400, spread: 0.025, color: '#5fd95f', burstCount: 3, burstDelay: 60, ammoCost: 3, botRange: 420 },
  ...
  { id: 'sniper', type: 'gun', dmg: 220, rate: 1400, speed: 1800, mag: 2, reload: 2200, spread: 0.0, pierce: true, color: '#bb88ff', zoom: 1.32, botRange: 650 },
  ...
  { id: 'minigun', type: 'gun', dmg: 15, rate: 45, speed: 900, mag: 120, reload: 4000, spread: 0.13, color: '#3cf0ff', spinUp: { startRate: 140, rampMs: 1200 }, moveSpeedMul: 0.62, botRange: 500 },
  ...
  { id: 'grenade', type: 'gun', dmg: 60,  rate: 700,  speed: 600, mag: 4, reload: 2400, spread: 0.03, explosive: 90,  color: '#9aff5a', botRange: 380 },
  // rocket: RAKETGEVÄR — spränghuvud (störst AoE, raksikte); mkt lång omladdning, 1 raket.
  { id: 'rocket',  type: 'gun', dmg: 130, rate: 1500, speed: 560, mag: 1, reload: 3200, spread: 0.02, explosive: 140, color: '#ff3c3c', botRange: 380 },

  // ── SPECIAL (mode-givna, EJ i shop/loot/gungame) ───────────────────────────
  // turret_mg: CTF-tornets MG (mountat). Hög DPS, ingen reload, immobil tradeoff.
  { id: 'turret_mg',  type: 'gun', dmg: 11, rate: 75, speed: 1100, mag: 9999, reload: 0, spread: 0.07, color: '#ff5a3a', botRange: 460 },
  // turret_rocket: Siege-tornens raket. Långsam, hög dmg + AoE.
  { id: 'turret_rocket', type: 'gun', dmg: 70, rate: 1700, speed: 700, mag: 9999, reload: 0, spread: 0.0, color: '#ff8a3a', explosive: 80, botRange: 380 },
  // gulag_knock: Gulag-knockback-kanon (The Void). 0 dmg, knuffar (bullets.js BR-hook).
  { id: 'gulag_knock', type: 'gun', dmg: 0, rate: 300, speed: 920, mag: 9999, reload: 0, spread: 0.03, color: '#5ac7ff', gulagKnock: true, botRange: 350 },
];
